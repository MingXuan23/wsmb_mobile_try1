...
import 'package:wsmb_day1_try1/day2/pages/ride_detail_page.dart';
...
class _RideCardState extends State<RideCard> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      decoration:
          BoxDecoration(border: Border.all(color: Colors.black, width: 2),color: (isJoin)?Colors.green:Colors.white),
